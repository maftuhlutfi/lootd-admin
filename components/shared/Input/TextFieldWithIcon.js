const TextFieldWithIcon = ({ className, icon, ...otherProps }) => {
    return (
        <div className={`relative`}>
            <input className={`peer border-0 rounded-2xl outline-none p-4 px-14 focus:ring-2 focus:ring-offset-indigo-500 transition-all duration-100 ${className}`} {...otherProps} />
